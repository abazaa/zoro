...
var =  'ملك التلجرام👑'
elseif  UserID == 913812904 then
var =  'مالك السورس'
elseif  UserID == 656329268 then
var =  'مطور السورس'
elseif redis:sismember(zoro..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(zoro..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(zoro..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(zoro..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(zoro..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(zoro..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(zoro..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(zoro..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(zoro..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(zoro..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(zoro..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(zoro..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(zoro..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local info = redis:hgetall(zoro..'username:'..v)
local count = redis:scard(zoro..'mtwr_count'..v)
...
local monsha = redis:smembers(zoro..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n• قائمه المدراء :*\n\n'
local list = redis:smembers(zoro..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(zoro..'admins:'..msg.chat_id_)
...
local list = redis:smembers(zoro..'whitelist:'..msg.chat_id_)
...
if redis:sismember(zoro..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(zoro..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(zoro..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(zoro..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(zoro..'gban_users')
...
local list = redis:smembers(zoro..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(zoro..':Filter_Word:'..msg.chat_id_,word) then 
return  "• **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(zoro..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(zoro..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(zoro..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(zoro..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(zoro..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(zoro..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(zoro..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(zoro..'group:ids')
message = '• **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(zoro..'group:name'..v)
if info then 
...
redis:del(
zoro..'group:add'..id_group,
zoro..'lock_link'..id_group, 
zoro..'lock_id'..id_group,
zoro..'lock_spam'..id_group, 
zoro..'lock_webpage'..id_group,
zoro..'lock_markdown'..id_group,
zoro..'lock_flood'..id_group,
zoro..'lock_bots'..id_group,
zoro..'mute_forward'..id_group,
zoro..'mute_contact'..id_group,
zoro..'mute_location'..id_group,
zoro..'mute_document'..id_group,
zoro..'mute_keyboard'..id_group,
zoro..'mute_game'..id_group,
zoro..'mute_inline'..id_group,
zoro..'lock_username'..id_group,
zoro..'num_msg_zoro'..id_group,
zoro..'replay'..id_group
)
redis:srem(zoro..'group:ids',id_group)
end
...
redis:hset(zoro..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(zoro..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(zoro..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(zoro..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(zoro..':addnumberusers') or 0)
...
local lock_service = redis:get(zoro..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(zoro..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(zoro..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
zoro..'group:add'..msg.chat_id_,true,
zoro..'lock_link'..msg.chat_id_,true, 
zoro..'lock_id'..msg.chat_id_,true,
zoro..'lock_spam'..msg.chat_id_,true,
zoro..'lock_webpage'..msg.chat_id_,true,
zoro..'lock_markdown'..msg.chat_id_,true,
zoro..'lock_flood'..msg.chat_id_,true,
zoro..'lock_bots'..msg.chat_id_,true,
zoro..'mute_forward'..msg.chat_id_,true,
zoro..'mute_contact'..msg.chat_id_,true,
zoro..'mute_location'..msg.chat_id_,true,
zoro..'mute_document'..msg.chat_id_,true,
zoro..'mute_keyboard'..msg.chat_id_,true,
zoro..'mute_game'..msg.chat_id_,true,
zoro..'mute_inline'..msg.chat_id_,true,
zoro..'lock_username'..msg.chat_id_,true,
zoro..'num_msg_zoro'..msg.chat_id_,5, 
zoro..'replay'..msg.chat_id_,true
)

redis:sadd(zoro..'group:ids',msg.chat_id_) 
redis:sadd(zoro..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)
...
if not redis:get(zoro..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
redis:hset(zoro..'username:'..UserID,'username',Resolv)
redis:sadd(zoro..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(zoro..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(zoro..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(zoro..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID,'username',Resolv)
redis:sadd(zoro..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(zoro..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(zoro..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(zoro..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..'whitelist:'..ChatID,UserID)
...
redis:srem(zoro..'whitelist:'..ChatID,UserID)
...
if redis:sismember(zoro..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..'owners:'..ChatID,UserID)
...
if redis:sismember(zoro..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(zoro..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(zoro..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المدير  \n✓️',17,USERCAR) 
end
...
if cmd == "active" then
local maseegs = redis:get(zoro..'msgs:'..UserID..':'..ChatID) or 1
...
if cmd == "unban" then
if not redis:sismember(zoro..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(zoro..'banned:'..ChatID,UserID)
...
if redis:sismember(zoro..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(zoro..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(zoro..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(zoro..'username:'..UserID, 'username',Resolv)
redis:sadd(zoro..'gban_users',UserID)
...
redis:srem(zoro..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(zoro..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(zoro..':SUDO_BOT:',UserID) then 
...
if redis:sismember(zoro..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'• **العضو » ❪ '..UserName..' ❫\n• **الايدي » ❪ `'..UserID..'` ❫\n• **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(zoro..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(zoro..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد المدير\n") 
elseif redis:sismember(zoro..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(zoro..'username:'..UserID, 'username', Resolv)
redis:sadd(zoro..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(zoro..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(zoro..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(zoro..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(zoro..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(zoro..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(zoro..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(zoro..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*•*` اعدادات المجموعه :` \n"
.."\n• التعديل «» "..(redis:get(zoro..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(zoro..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(zoro..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(zoro..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(zoro..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(zoro..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(zoro..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(zoro..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(zoro..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(zoro..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(zoro..'num_msg_zoro'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(zoro..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(zoro..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(zoro..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(zoro..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(zoro..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(zoro..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(zoro..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(zoro..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(zoro..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(zoro..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(zoro..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(zoro..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(zoro..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(zoro..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(zoro..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(zoro..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(zoro..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(zoro..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(zoro..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(zoro..'num_msg_zoro'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(zoro..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(zoro..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(zoro..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(zoro..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(zoro..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
