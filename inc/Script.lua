...
if redis:get(zoro.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'✵- 𝑵𝑨𝑴𝑬 ᯾   '..Namei..'     \n✵- 𝑼𝑺𝑬𝑹 ᯾ '..UserNameID..' .\n✵- 𝑴𝑺𝑮𝑬 ᯾ '..msgs..' .\n✵- 𝑺𝑻𝑨 ᯾ '..msg.TheRank..' .\n✵- 𝑰𝑫 ᯾ '..msg.sender_user_id_..' \n✵- 𝑪𝑯 ᯾ @SOURCE_ZORO .',dl_cb,nil)
		else
...
༆-[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑❷✯](t.me/IE_S9)

༆-[𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐎𝐑𝐎✯](t.me/SOURCE_ZORO) 

༆-[𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍✯](t.me/xb_1b)

༆-[𝐓𝐎 𝐓𝐀𝑳𝐊 𝐔𝐒 ✯](t.me/Tawaslzorobot)
]]
end
