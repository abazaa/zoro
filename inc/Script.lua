...
redis:set(zoro.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(zoro..'lock:join:'..msg.chat_id_,true)
...
redis:del(zoro..'lock:join:'..msg.chat_id_)
...
Channel = redis:get(zoro..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(zoro..'joinchnl') then
...
redis:set(zoro.."getidstatus"..msg.chat_id_, "Photo")
redis:set(zoro..'lock:kara:'..msg.chat_id_,'off')
return modadd(msg)  
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(zoro..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(zoro..'CheckExpire::'..msg.chat_id_) then 
...
if MsgText[2] == '3' then
redis:set(zoro..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(zoro..'CheckExpire::'..msg.chat_id_) then 
redis:set(zoro..'CheckExpire::'..msg.chat_id_,true) end
...
local GroupName = (redis:get(zoro..'group:name'..msg.chat_id_) or '')
redis:set(zoro..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. zoro..'')
...
if not msg.Director and redis:get(zoro..'lock_pin'..msg.chat_id_) then
...
local Admins = redis:scard(zoro..'admins:'..msg.chat_id_)
redis:del(zoro..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(zoro..'owners:'..msg.chat_id_)
redis:del(zoro..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(zoro..'whitelist:'..msg.chat_id_)
redis:del(zoro..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(zoro..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(zoro..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(zoro..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(zoro..'linkGroup'..msg.sender_user_id_,300,true)
...
local GroupName = redis:get(zoro..'group:name'..msg.chat_id_)
local GroupLink = redis:get(zoro..'linkGroup'..msg.chat_id_)
...
local Text = "• رابـط الـمـجـمـوعه • \n"..Flter_Markdown(redis:get(zoro..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:setex(zoro..'rulse:witting'..msg.sender_user_id_,300,true)
...
return "*• القوانين :*\n"..redis:get(zoro..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(zoro..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(zoro..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "• ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(zoro..':Filter_Word:'..msg.chat_id_)
...
redis:del(zoro..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(zoro..'welcome:msg'..msg.chat_id_) then 
return "• ** اوه هنالك خطأ .\n• عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(zoro..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(zoro..':Hussain:'..msg.chat_id_)
redis:del(zoro..':Hussain:'..msg.chat_id_)
return "• **أهلا عزيزي "..msg.TheRankCmd.."   \n•  تم مسح {* "..NumMnsha.." *} المنشى الاساسي \n✓"
end


if MsgText[2] == "المنشئيين" then
if not msg.kara then return "• **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(zoro..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "• عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(zoro..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(zoro..'banned:'..msg.chat_id_)
if #list == 0 then return "*• لا يوجد مستخدمين محظورين  *" end
message = '• ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(zoro..'banned:'..msg.chat_id_)
...
redis:del(zoro..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(zoro..'name:witting'..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "• **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(zoro..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(zoro..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(zoro..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(zoro..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(zoro..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local msgs = redis:get(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local rfih = (redis:get(zoro..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(zoro.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'✶- 𝒏𝒂𝒎𝒆𓂅   '..Namei..'     \n✶- 𝒖𝒔𝒆𝒓𓂅 '..UserNameID..' .\n✶- 𝒎𝒔𝒈𝒆𓂅 '..msgs..' .\n✶- 𝒔𝒕𝒂𓂅 '..msg.TheRank..' .\n✶- 𝒊𝒅 𓂅 '..msg.sender_user_id_..' \n ✶- 𝒄𝒉𓂅 @TAMER_HOSNI .',dl_cb,nil)
		else
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(zoro..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(zoro..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(zoro..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(zoro..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(zoro..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(zoro..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(zoro..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "• **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '• **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "• **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(zoro..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(zoro..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(zoro..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(zoro..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(zoro..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(zoro..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(zoro..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(zoro..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(zoro..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(zoro..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(zoro..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "• **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(zoro..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(zoro..'welcome:msg'..msg.chat_id_))
else 
return "• **أهلا عزيزي "..msg.TheRankCmd.."  \n• نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(zoro..'group:ids')
...
local Photo_Weloame = redis:get(zoro..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[• اهلا انا بوت]]..redis:get(zoro..':NameBot:')..[[ .
...
redis:set(zoro..':addnumberusers',MsgText[2]) 
return '•☆ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'•☆ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(zoro..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات ☆" then
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
return '• ** عدد المجموعات المفعلة » `'..redis:scard(zoro..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين ☆" then
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
return '• **عدد المشتركين في البوت : `'..redis:scard(zoro..'users')..'` \n'
end
...
if not msg.SudoUser then return "•☆ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(zoro..'group:ids',MsgText[2]) then
...
return redis:get(zoro..":TEXT_SUDO") or '• لا توجد كليشه المطور .\n• يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه ☆" then
if not msg.SudoUser then return"•☆ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(zoro..'lock_brod') then 
return "•☆ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(zoro..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(zoro..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(zoro..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(zoro..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:del(zoro..'welcom:witting'..msg.sender_user_id_,
zoro..'rulse:witting'..msg.sender_user_id_,
zoro..'rulse:witting'..msg.sender_user_id_,
zoro..'name:witting'..msg.sender_user_id_,
zoro..'about:witting'..msg.sender_user_id_,
zoro..'fwd:all'..msg.sender_user_id_,
zoro..'fwd:pv'..msg.sender_user_id_,
zoro..'fwd:groups'..msg.sender_user_id_,
zoro..'namebot:witting'..msg.sender_user_id_,
zoro..'addrd_all:'..msg.sender_user_id_,
zoro..'delrd:'..msg.sender_user_id_,
zoro..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
zoro..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
zoro..'addrd:'..msg.sender_user_id_,
zoro..'delrdall:'..msg.sender_user_id_,
zoro..":ForceSub:"..msg.sender_user_id_,
zoro..'text_sudo:witting'..msg.sender_user_id_,
zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_,
zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(zoro..":VERSION",GetVerison)
return false
else
...
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '•☆ الاحصائيات . \n\n•☆ **عدد المجموعات المفعله : '..redis:scard(zoro..'group:ids')..'\n• **عدد المشتركين في البوت : '..redis:scard(zoro..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ☆" then
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(zoro..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا الان ارسل كلمة الرد العام .\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "• **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(zoro..'replay:'..msg.chat_id_)
local photo 	= redis:exists(zoro..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(zoro..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(zoro..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(zoro..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(zoro..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(zoro..'replay_video:group:'..msg.chat_id_)
...
zoro..'replay_animation:group:'..msg.chat_id_,zoro..'replay_audio:group:'..msg.chat_id_,zoro..'replay_sticker:group:'..msg.chat_id_,zoro..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(zoro..'replay:all')
local photo 	= redis:exists(zoro..'replay_photo:group:')
local voice 	= redis:exists(zoro..'replay_voice:group:')
local imation 	= redis:exists(zoro..'replay_animation:group:')
local audio 	= redis:exists(zoro..'replay_audio:group:')
local sticker 	= redis:exists(zoro..'replay_sticker:group:')
local video 	= redis:exists(zoro..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(zoro..'replay:all',zoro..'replay_photo:group:',zoro..'replay_voice:group:',zoro..'replay_animation:group:',zoro..'replay_audio:group:',zoro..'replay_sticker:group:',zoro..'replay_video:group:')
...
if not msg.Director then return "•☆ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(zoro..'delrd:'..msg.sender_user_id_,true)
return "•☆ حسننا عزيزي  .\n• الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "•☆ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(zoro..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(zoro..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(zoro..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(zoro..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(zoro..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(zoro..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(zoro..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(zoro..'replay:all')
local photo 	= redis:hkeys(zoro..'replay_photo:group:')
local voice 	= redis:hkeys(zoro..'replay_voice:group:')
local imation 	= redis:hkeys(zoro..'replay_animation:group:')
local audio 	= redis:hkeys(zoro..'replay_audio:group:')
local sticker 	= redis:hkeys(zoro..'replay_sticker:group:')
local video 	= redis:hkeys(zoro..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '•☆ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "•☆ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(zoro..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "• حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(zoro..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "•☆ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if not redis:get(zoro..'lave_me'..msg.chat_id_) then 
return "•☆ **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(zoro..'lave_me'..msg.chat_id_) 
return "• **أهلا عزيزي "..msg.TheRankCmd.."\n• ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "•☆ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n• " end
if redis:get(zoro..'lave_me'..msg.chat_id_) then 
return "•☆ **أهلا عزيزي "..msg.TheRankCmd.."\n• ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(zoro..'lave_me'..msg.chat_id_,true)  
...
return [[
 ...
 ༄[𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁✯](t.me/Bahjat100)
 ≪━━━☆☆☆━━━≫
༄[𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁✯](https://t.me/IE_S9)
  ≪━━━☆☆☆━━━≫
  ༄[𝙲𝙷𝙰𝙽𝙽𝙴𝙻 𝚉𝙾𝚁𝙾✯](https://t.me/TAMER_HOSNI)
  ≪━━━☆☆☆☆☆━━━≫
༄[𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝙾𝙽✯](https://t.me/xb_1b)
≪━━━☆☆☆☆☆━━━≫
 ༄[𝚃𝙾𝙰𝙻𝙺 𝚃𝙾 𝚄𝚂✯](t.me/Tawaslzorobot)
]]
end
...
redis:del(zoro..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
...
redis:setex(zoro..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"•☆ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(zoro..":UserNameChaneel")
if UserChaneel then
...
if redis:get(zoro..'welc'..msg.chat_id_) == 'on' then
...
mmd = redis:get(zoro..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(zoro..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(zoro..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'• اهلا عزيزي \n• تم تثبيت الامر الجديد\n✓')
redis:del(zoro..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(zoro..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(zoro..'CmD:'..msg.chat_id_,cmd)
redis:srem(zoro..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"•☆ اهلا عزيزي\nالامر >"..cmd.."\n• تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(zoro..'CmD:'..msg.chat_id_)
redis:del(zoro..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"•☆ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "•☆ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(zoro..'CmDlist:'..msg.chat_id_)
local t = '• قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(zoro..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
if redis:get(zoro..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(zoro..'welc'..msg.chat_id_,'off')
redis:del(zoro..'welc'..msg.chat_id_,'on')
else
...
local msg_pv = tonumber(redis:get(zoro..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(zoro..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*• * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(zoro..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(zoro..'users',msg.sender_user_id_)
if redis:get(zoro..'lock_service') then 
text = [[• أهلاً انا بوت   []]..redis:get(zoro..':NameBot:')..[[] 🗽
...
ــــــــــــــــــــــــــــــــ☆𝑍𝑂𝑅𝑂☆ـــــــــــــــــــــــــ
...
local MSG_ID = (redis:get(zoro.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
redis:setex(zoro.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(zoro..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(zoro..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(zoro..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n• تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(zoro..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(zoro..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(zoro..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(zoro..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(zoro..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد بنجاح\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(zoro..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(zoro..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(zoro..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(zoro..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  • تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(zoro..'replay_photo:group:',klma,photo_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه صوره للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(zoro..'replay_voice:group:',klma,voice_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه بصمه صوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(zoro..'replay_animation:group:',klma,animation_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه متحركه للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(zoro..'replay_video:group:',klma,video_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه فيديو للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(zoro..'replay_audio:group:',klma,audio_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'• تم اضافه للصوت للرد العام\n• يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(zoro..'replay_sticker:group:',klma,sticker_id)
redis:del(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(zoro..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(zoro..":ForceSub:"..msg.sender_user_id_)
...
redis:set(zoro..":UserNameChaneel",msg.text)
...
if redis:get(zoro..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(zoro..'namebot:witting'..msg.sender_user_id_)
redis:set(zoro..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"• تم تغير اسم البوت  .\n• الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(zoro..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(zoro..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(zoro..'replay_photo:group:',msg.text)
redis:hdel(zoro..'replay_voice:group:',msg.text)
redis:hdel(zoro..'replay_animation:group:',msg.text)
redis:hdel(zoro..'replay_audio:group:',msg.text)
redis:hdel(zoro..'replay_sticker:group:',msg.text)
redis:hdel(zoro..'replay_video:group:',msg.text)
redis:setex(zoro..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جوا ب الردالعام \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(zoro..'delrdall:'..msg.sender_user_id_) then
redis:del(zoro..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(zoro..'replay:all',msg.text)
local photo =redis:hget(zoro..'replay_photo:group:',msg.text)
local voice = redis:hget(zoro..'replay_voice:group:',msg.text)
local animation = redis:hget(zoro..'replay_animation:group:',msg.text)
local audio = redis:hget(zoro..'replay_audio:group:',msg.text)
local sticker = redis:hget(zoro..'replay_sticker:group:',msg.text)
local video = redis:hget(zoro..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(zoro..'replay:all',msg.text)
redis:hdel(zoro..'replay_photo:group:',msg.text)
redis:hdel(zoro..'replay_voice:group:',msg.text)
redis:hdel(zoro..'replay_audio:group:',msg.text)
redis:hdel(zoro..'replay_animation:group:',msg.text)
...
if redis:get(zoro..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(zoro..'welcom:witting'..msg.sender_user_id_) 
redis:set(zoro..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(zoro..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(zoro..'rulse:witting'..msg.sender_user_id_) 
redis:set(zoro..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• ** مرحبآ عزيزي\n• تم حفظ القوانين بنجاح .\n• ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(zoro..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(zoro..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(zoro..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(zoro..'linkGroup'..msg.sender_user_id_,link) 
redis:set(zoro..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'• تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(zoro..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(zoro..'about:witting'..msg.sender_user_id_) 
...
if redis:get(zoro..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
...
if redis:get(zoro..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
...
if redis:get(zoro..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(zoro..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(zoro..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(zoro..':WELCOME_BOT') then
...
if msg.forward_info and redis:get(zoro..'fwd:'..msg.sender_user_id_) then
redis:del(zoro..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(zoro..'users')
local groups = redis:smembers(zoro..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(zoro..'welcom_ph:witting'..msg.sender_user_id_) then
...
redis:set(zoro..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'• تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(zoro..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(zoro..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(zoro..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(zoro..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(zoro..'replay:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(zoro..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(zoro..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"• جيد , يمكنك الان ارسال جواب الرد \n• [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(zoro..'delrd:'..msg.sender_user_id_) then
redis:del(zoro..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(zoro..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(zoro..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(zoro..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(zoro..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(zoro..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(zoro..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(zoro..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'• **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(zoro..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(zoro..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(zoro..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(zoro..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
if redis:get(zoro..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(zoro..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(zoro..'welcome:msg'..msg.chat_id_) or "• اهلاً عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(zoro..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه .\n")
...
--------------------------------------------
if msg.adduser and redis:get(zoro..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(zoro..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(zoro..'welcome:get'..msg.chat_id_)
end
redis:setex(zoro..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(zoro..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(zoro..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_zoro = (redis:get(zoro..'num_msg_zoro'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_zoro) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(zoro..'sender:'..msg.sender_user_id_..':flood',30,true)
...
redis:setex(zoro..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(zoro..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(zoro..'lock_woring'..msg.chat_id_) and not redis:get(zoro..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(zoro..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(zoro..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(zoro..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(zoro..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(zoro..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(zoro..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(zoro..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(zoro..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(zoro..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(zoro..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(zoro..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(zoro..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(zoro..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(zoro..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(zoro..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(zoro..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(zoro..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(zoro..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(zoro..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(zoro..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(zoro..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(zoro..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(zoro..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(zoro..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(zoro..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(zoro..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(zoro..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(zoro..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(zoro..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(zoro..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(zoro..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(zoro..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(zoro..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(zoro..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(zoro..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
ٴ≪━━━━━𝑍𝑂𝑅𝑂━━━━━≫ٴ
 ...
 ✸ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "فيرو" or Text== " فارس " or Text=="basel abaza" then
...
if not redis:get('kar') then
  ...
  local All_Groups_ID = redis:smembers(zoro..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(zoro..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(zoro..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(zoro..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(zoro..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(zoro..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(zoro..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(zoro..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(zoro..'ExpireDate:'..msg.chat_id_)
  ...
  local DaysEx = (redis:ttl(zoro..'ExpireDate:'..msg.chat_id_) / 86400)
